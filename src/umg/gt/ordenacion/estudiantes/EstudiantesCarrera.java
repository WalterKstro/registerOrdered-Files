...
/**
 * Clase EstudiantesCarrera que implemnta la interfaz Comparable
 * para luego sobreescriir el metodo compareTo para la ordenacion
 * de la lista estudiantes
 * @author walte
 */
public class EstudiantesCarrera implements Comparable<EstudiantesCarrera> {
/**
 ...
 */
    ...
    /**
     * Declaracion del constructor de la clase EstudiantesCarrera inicializando
     * las variables
     ...
     */
    public EstudiantesCarrera(String carne, String nombre, String apellido,String carrera) {
        this.carne = carne;
        this.nombre = nombre;
 ...
 */
    @Override
    public int compareTo(EstudiantesCarrera e) {
        return this.getCarrera().compareTo(e.getCarrera());
    }
